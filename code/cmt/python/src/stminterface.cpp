...
const char* STM_train_doc =
	...
	"\t>>> \t'regularize_biases': {'strength': 0., 'norm': 'L2'},\n"
	"\t>>> \t'regularize_features': {'strength': 0., 'norm': 'L2'},\n"
	"\t>>> \t'regularize_weights': {'strength': 0., 'norm': 'L2'},\n"
	"\t>>> \t'regularize_predictors': {'strength': 0., 'norm': 'L2'}\n"
	"\t>>> \t'regularize_linear_predictor': {'strength': 0., 'norm': 'L2'}\n"
	"\t>>> })\n"
	"\n"
